...
public class FirstAdapter extends RecyclerView.Adapter {
    ...
    public FirstAdapter(Context context , FirstPresenter presenter) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if(viewType == LOAD_TYPE){
            ...
            view = LayoutInflater.from(parent.getContext()).inflate(R.layout.he_first1_news, parent, false);
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        if(holder instanceof FristViewHodler) {
            ...
            /**NewsItem*/
            FirstNewsItem item = mPresenter.getFavoriteAndComment();
