...
public class FirstNewsFragment extends Fragment implements FirstView,
    ...
    private static FirstNewsFragment instance;
    public static FirstNewsFragment getInstance(int type){
        instance = new FirstNewsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.he_first_list, null);
