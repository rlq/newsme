...
public class FristModel {
    ...
    public String id ;
    public FristModel(Context context){
    ...
    public FristNewsItem getFavoriteAndComment(){
        FristNewsItem item = new FristNewsItem();
