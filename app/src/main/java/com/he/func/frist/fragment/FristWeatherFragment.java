...
public class FristWeatherFragment extends Fragment implements WeatherView,FristView,
    ...
    private static FristWeatherFragment instance;
    public static FristWeatherFragment getInstance(){
        if(instance == null){
            instance = new FristWeatherFragment();
        }
        return instance;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.he_frist3, null);
