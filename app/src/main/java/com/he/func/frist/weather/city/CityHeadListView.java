...
public class CityHeadListView extends ListView {

	public interface HeaderAdapter {
		int HEADER_GONE = 0;
		int HEADER_VISIBLE = 1;
		int HEADER_PUSHED_UP = 2;
	...
	public CityHeadListView(Context context) {
		super(context);
	}

	public CityHeadListView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public CityHeadListView(Context context, AttributeSet attrs, int defStyle) {
